    ...
    return `<div id="1" class="request shadow-lg p-3 mb-5 bg-body rounded displayRequest">
                <div class="d-flex w-100 justify-content-between">
                    <div class="form-check">
                        <label id="film" class="form-check-label labelRequest"><b>Film:</b> ${request.citta}</label>
                        <label class="form-check-label labelRequest"><b>Regista:</b> ${request.via}</label>
                        <label class="form-check-label labelRequest"><b>Genere:</b> ${request.descrizione}</label>
...
function createComuneRequestPendente(request){
    ...
    <div class="d-flex w-100 justify-content-between">
      <div class="form-check">
        <label id="film" class="form-check-label labelRequest classeFilm">Film: ${request.citta}
        </label>
        <label id="regia" class="form-check-label labelRequest classeRegia">Regia: ${request.via}
        </label>
        <label id="genere" class="form-check-label labelRequest classeGenere">Genere: ${request.descrizione}
        </label>
...
function createComuneRequestSoddisfatta(request){
    ...
    <div class="d-flex w-100 justify-content-between">
      <div class="form-check">
        <label id="film" class="form-check-label labelRequest classeFilm"><b>Film:</b> ${request.citta}
        </label>
        <label id="regia" class="form-check-label labelRequest classeRegia"><b>Regia:</b> ${request.via}
        </label>
        <label id="genere" class="form-check-label labelRequest classeGenere"><b>Genere:</b> ${request.descrizione}
        </label>
